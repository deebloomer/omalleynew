...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { description: @testimonial.description, email: @testimonial.email, name: @testimonial.name }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { description: @testimonial.description, email: @testimonial.email, name: @testimonial.name }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
